 ...
 * claim has been released, and everything else (processed, duplicate, stale,
 * ignored) is 200. Stripe retries non-2xx deliveries automatically for days, so a
 * transient database error never leaves an account stale behind a 2xx.
 */
