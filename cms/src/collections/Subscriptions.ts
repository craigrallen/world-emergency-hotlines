...
export const Subscriptions: CollectionConfig = {
  ...
  fields: [
    ...
    { name: 'lastEventCreated', type: 'number', admin: { readOnly: true, description: 'Unix seconds of the newest Stripe event applied; older events never overwrite newer state.' } },
