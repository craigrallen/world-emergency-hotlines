...
export function generateReleaseIntegrity({ datasetVersion }) {
  ...
  const relationshipPaths = [
    ...
    '/assurance-packs/v1/README.md', '/assurance-packs/v1/assurance-pack.schema.json', '/assurance-packs/v1/assurance-pack.synthetic.json',
  ];
  const payload = {
    schema_version: RELEASE_SCHEMA_VERSION,
    canonical_origin: CANONICAL_ORIGIN,
    ...
    artifact_index: {
      ...
      coverage: ['/data/**', '/api/v1/**', '/widget/v1/hotlines-widget.js', '/release/v1/changes.json', '/release/v1/changes/**', '/feeds/**', '/subscriptions/v1/**', '/gateway/v1/**', '/organizations/v1/**', '/managed-widget-config/v1/**', '/technical-health/v1/**', '/assurance-packs/v1/**'],
