...
export const BUILD_VERSION_INPUTS = {
  ...
  offline_shell: ['scripts/generate-pwa-assets.mjs', 'src/layouts/Base.astro', 'src/lib/i18n.ts', 'src/lib/locale-status.json', 'src/components/LanguageSwitcher.astro', 'src/components/Footer.astro', 'src/pages/language-status.astro', 'public/favicon-192x192.png', 'public/favicon.svg', 'repo:Caddyfile'],
};
...
export function generateReleaseIntegrity({ datasetVersion }) {
  ...
  const relationshipPaths = [
    '/data/manifest.json', '/api/v1/manifest.json', '/api/v1/records.json', '/api/v1/traveler-cards.json', '/api/v1/traveler-cards.json.gz',
