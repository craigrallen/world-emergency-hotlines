...
// Values are approximate geographic centers, sufficient for placing a marker
// or flying the map to a country. Sourced from public-domain datasets
// (Natural Earth / Google's country centroids).
...
// A compact lookup — only includes the alpha-2s we currently display.
// If a code is missing, callers fall back to the bounding box of the
// country polygon loaded from world-atlas. This map is a quick path.
...
export function centroidFor(alpha2: string): Centroid | null {
