...
const COUNTRY_ALIASES = {
  ...
  australia: ['ऑस्ट्रेलिया', '澳大利亚', '澳洲', 'オーストラリア', 'австралия'],
  china: ['中国'],
  japan: ['日本'],
