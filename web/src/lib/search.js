...
const COUNTRY_ALIASES = {
  ...
  'united states': ['usa', 'united states', 'us', 'etats unis', 'estados unidos', 'vereinigte staaten', 'stati uniti', 'verenigde staten', 'förenta staterna', 'forenede stater', 'forente stater', 'yhdysvallat', 'stany zjednoczone', 'amerika birlesik devletleri', 'amerika birleşik devletleri', 'الولايات المتحدة', 'أمريكا', 'امريكا', 'अमेरिका', 'संयुक्त राज्य अमेरिका', '美国', 'アメリカ', '米国', 'сша', 'соединенные штаты', 'соединенные штаты америки', '미국', 'hoa kỳ'],
  ...
  china: ['中国', '중국', 'trung quốc'],
  japan: ['日本', '일본', 'nhật bản'],
  russia: ['россия', 'российская федерация'],
  'south korea': ['대한민국', '한국', 'hàn quốc'],
  vietnam: ['viet nam'],
};
