...
const COUNTRY_ALIASES = {
  ...
  france: ['francia', 'franca', 'frankreich', 'frankrijk', 'frankrike', 'ranska', 'francja', 'fransa', 'فرنسا', 'फ्रांस', '法国', 'フランス', 'франция'],
  spain: ['espana', 'espagne', 'espanha', 'spanien', 'spagna', 'spanje', 'espanja', 'hiszpania', 'ispanya', 'İspanya', 'إسبانيا', 'اسبانيا', 'स्पेन', '西班牙', 'スペイン', 'испания'],
  germany: ['allemagne', 'alemanha', 'deutschland', 'germania', 'duitsland', 'tyskland', 'saksa', 'niemcy', 'almanya', 'ألمانيا', 'المانيا', 'जर्मनी', '德国', 'ドイツ', 'германия'],
  ...
  canada: ['कनाडा', '加拿大', 'カナダ', '캐나다'],
  australia: ['ऑस्ट्रेलिया', '澳大利亚', '澳洲', 'オーストラリア', 'австралия', '호주'],
  china: ['中国', '중국'],
  japan: ['日本', '일본'],
