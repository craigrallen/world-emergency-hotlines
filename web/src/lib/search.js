...
const CATEGORY_ALIASES = {
  ...
  domestic_violence: ['domestic violence', 'domestic abuse', 'violencia domestica', 'violence domestique', 'violences conjugales', 'dv', 'haeusliche gewalt', 'häusliche gewalt', 'violenza domestica', 'huiselijk geweld', 'våld i hemmet', 'vold i hjemmet', 'perheväkivalta', 'perhevakivalta', 'przemoc domowa', 'ev ici siddet', 'ev içi şiddet', 'aile ici siddet', 'aile içi şiddet', 'العنف المنزلي', 'عنف منزلي', 'العنف الأسري', 'عنف أسري', 'घरेलू हिंसा', '家庭暴力', '家暴', 'ドメスティックバイオレンス', '家庭内暴力'],
  suicide_crisis: ['suicide crisis', 'suicide', 'suicidal', 'suicidaire', 'suicidio', 'suicida', 'suizid', 'suizidal', 'zelfmoord', 'suicidaal', 'självmord', 'selvmord', 'itsemurha', 'samobojstwo', 'samobójstwo', 'intihar', 'انتحار', 'أفكار انتحارية', 'افكار انتحارية', 'आत्महत्या', '自杀', '自杀危机', '自殺', '自殺予防'],
  mental_health: ['mental health', 'salud mental', 'sante mentale', 'saude mental', 'psychische gesundheit', 'salute mentale', 'mentale gezondheid', 'geestelijke gezondheid', 'psykisk hälsa', 'psykisk sundhed', 'psykisk helse', 'mielenterveys', 'zdrowie psychiczne', 'ruh sagligi', 'ruh sağlığı', 'الصحة النفسية', 'صحة نفسية', 'मानसिक स्वास्थ्य', '心理健康', '精神健康', 'メンタルヘルス', '精神保健'],
...
const COUNTRY_ALIASES = {
  ...
  france: ['francia', 'franca', 'frankreich', 'frankrijk', 'frankrike', 'ranska', 'francja', 'fransa', 'فرنسا', 'फ्रांस', '法国', 'フランス'],
  spain: ['espana', 'espagne', 'espanha', 'spanien', 'spagna', 'spanje', 'espanja', 'hiszpania', 'ispanya', 'İspanya', 'إسبانيا', 'اسبانيا', 'स्पेन', '西班牙', 'スペイン'],
  germany: ['allemagne', 'alemanha', 'deutschland', 'germania', 'duitsland', 'tyskland', 'saksa', 'niemcy', 'almanya', 'ألمانيا', 'المانيا', 'जर्मनी', '德国', 'ドイツ'],
  italy: ['italia', 'italie', 'italië', 'italya'],
  'united kingdom': ['uk', 'royaume uni', 'reino unido', 'vereinigtes koenigreich', 'vereinigtes königreich', 'regno unito', 'verenigd koninkrijk', 'storbritannien', 'storbritannia', 'yhdistynyt kuningaskunta', 'wielka brytania', 'birlesik krallik', 'birleşik krallık', 'المملكة المتحدة', 'بريطانيا', 'यूनाइटेड किंगडम', '英国', 'イギリス'],
  'united states': ['usa', 'united states', 'us', 'etats unis', 'estados unidos', 'vereinigte staaten', 'stati uniti', 'verenigde staten', 'förenta staterna', 'forenede stater', 'forente stater', 'yhdysvallat', 'stany zjednoczone', 'amerika birlesik devletleri', 'amerika birleşik devletleri', 'الولايات المتحدة', 'أمريكا', 'امريكا', 'अमेरिका', 'संयुक्त राज्य अमेरिका', '美国', 'アメリカ', '米国'],
  'united arab emirates': ['uae', 'الإمارات', 'الامارات', '阿联酋'],
  sweden: ['sverige', 'ruotsi', 'szwecja', 'isvec', 'isveç', 'السويد', 'स्वीडन', '瑞典', 'スウェーデン'],
  ...
  lebanon: ['لبنان'],
  india: ['भारत', '印度', 'インド'],
  canada: ['कनाडा', '加拿大', 'カナダ'],
  australia: ['ऑस्ट्रेलिया', '澳大利亚', '澳洲', 'オーストラリア'],
  china: ['中国'],
  japan: ['日本'],
};
