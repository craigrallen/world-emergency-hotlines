...
4. **1,673 records (51%) have no `languages` value**, and **1,095 (34%) have no `hours` value** — mostly the `legacy_unverified` and `cross_referenced` tiers, which is expected until those tiers are enriched or web-verified.
