...
const COVERAGE=['/data/**','/api/v1/**','/widget/v1/hotlines-widget.js','/release/v1/changes.json','/release/v1/changes/**','/feeds/**','/subscriptions/v1/**','/gateway/v1/**','/organizations/v1/**','/managed-widget-config/v1/**'];
const ORGANIZATION_COVERAGE=COVERAGE.slice(0,-1);
const LEGACY_COVERAGE=ORGANIZATION_COVERAGE.slice(0,-1);
const EXCLUDES=['/release/v1/artifacts.json','/release/v1/release.json'];
const RELATIONSHIP_PATHS=['/data/manifest.json','/api/v1/manifest.json','/api/v1/records.json','/api/v1/resolver.js','/widget/v1/hotlines-widget.js','/data/metadata-coverage.json','/data/categories-stats.json','/data/search-index.json','/release/v1/changes.json','/release/v1/changes/latest.json','/feeds/releases.json','/feeds/releases.rss','/feeds/releases.atom','/subscriptions/v1/README.md','/subscriptions/v1/common.schema.json','/subscriptions/v1/event.schema.json','/subscriptions/v1/subscription-request.schema.json','/subscriptions/v1/subscription-response.schema.json','/subscriptions/v1/error.schema.json','/subscriptions/v1/openapi.json','/subscriptions/v1/webhook-contract.json','/subscriptions/v1/fixture-baseline.json','/subscriptions/v1/fixture-no-change.json','/subscriptions/v1/fixture-added.json','/subscriptions/v1/fixture-modified.json','/subscriptions/v1/fixture-country-metadata.json','/gateway/v1/README.md','/gateway/v1/artifact-descriptor.schema.json','/gateway/v1/error.schema.json','/gateway/v1/health.schema.json','/gateway/v1/key-record.schema.json','/gateway/v1/openapi.json','/gateway/v1/privacy.json','/gateway/v1/security.json','/organizations/v1/README.md','/organizations/v1/fixture.synthetic.json','/organizations/v1/model.schema.json','/organizations/v1/openapi.json','/managed-widget-config/v1/README.md','/managed-widget-config/v1/config.schema.json','/managed-widget-config/v1/envelope.schema.json','/managed-widget-config/v1/fixture.synthetic.json','/managed-widget-config/v1/keys.synthetic.json','/managed-widget-config/v1/openapi.json'];
...
const ORGANIZATION_RELATIONSHIP_PATHS=RELATIONSHIP_PATHS.filter(path=>!path.startsWith('/managed-widget-config/v1/'));
const ORGANIZATION_BUILD_INPUTS={...BUILD_INPUTS,integration_generator:BUILD_INPUTS.integration_generator.filter(path=>path!=='scripts/generate-managed-widget-config-contracts.mjs'&&path!=='repo:managed-widget-config/model.mjs')};
...
function coveredArtifactPath(path,profile){return path.startsWith('/data/')||path.startsWith('/api/v1/')||path==='/widget/v1/hotlines-widget.js'||path==='/release/v1/changes.json'||path.startsWith('/release/v1/changes/')||path.startsWith('/feeds/')||path.startsWith('/subscriptions/v1/')||path.startsWith('/gateway/v1/')||(profile!=='legacy'&&path.startsWith('/organizations/v1/'))||(profile==='current'&&path.startsWith('/managed-widget-config/v1/'));}
