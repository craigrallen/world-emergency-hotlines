...
const EVIDENCE_BUILD_INPUTS={...BUILD_INPUTS,integration_generator:BUILD_INPUTS.integration_generator.filter(path=>path!=='scripts/generate-evidence-backed-coverage-contracts.mjs'&&path!=='repo:evidence-backed-coverage/model.mjs')};
